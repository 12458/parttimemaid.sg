...
if (isset($conn)) {
    ...
    if (isset($rzvy_translangArr['one_time_label'])) {
        $fq_one_time_label = $rzvy_translangArr['one_time_label'];
    } else {
        $fq_one_time_label = $rzvy_defaultlang['one_time_label'];
    }
    if (isset($rzvy_translangArr['weekly_label'])) {
        $fq_weekly_label = $rzvy_translangArr['weekly_label'];
    } else {
        $fq_weekly_label = $rzvy_defaultlang['weekly_label'];
    }
    if (isset($rzvy_translangArr['biweekly_label'])) {
        $fq_biweekly_label = $rzvy_translangArr['biweekly_label'];
    } else {
        $fq_biweekly_label = $rzvy_defaultlang['biweekly_label'];
    }
    if (isset($rzvy_translangArr['monthly_label'])) {
        $fq_monthly_label = $rzvy_translangArr['monthly_label'];
    } else {
        $fq_monthly_label = $rzvy_defaultlang['monthly_label'];
    }
