				...
				<div class="modal-body">
					<div class="row">
						<ul class="rzvy-legend">
							...
							<li class="rzvy_color_rescheduled_by_customer float-none"><span></span> <?php if(isset($rzvy_translangArr['rescheduled_by_you'])){ echo $rzvy_translangArr['rescheduled_by_you']; }else{ echo $rzvy_defaultlang['rescheduled_by_you']; } ?></li>
							<li class="rzvy_color_cancelled_by_customer float-none"><span></span> <?php if(isset($rzvy_translangArr['cancelled_by_you'])){ echo $rzvy_translangArr['cancelled_by_you']; }else{ echo $rzvy_defaultlang['cancelled_by_you']; } ?></li>
