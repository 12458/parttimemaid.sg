...
$cs_bfls_bgcolor = $obj_settings->get_option("rzvy_cs_bfls_primary_color"); 
$cs_bfls_tcolor = $obj_settings->get_option("rzvy_cs_bfls_primary_color"); 
...
if($cs_bfls == "custom"){
	...
	<style>	
		...
		.rzvy-mb #rzvy_book_appointment_btn{
			color:<?php echo $cs_bfls_scolor;?> !important;
		}
		.rzvy-mb .rzvy-sidebar-block-title h5{
			color: <?php echo $cs_bfls_scolor;?> !important;
			background-color: <?php echo $cs_bfls_pcolor;?> !important;
		}
		.rzvy-mb .rzvy-booking-detail-block{
		...
		.rzvy-mb .rzvy-addons-multipleqty-box-icon,.rzvy-mb .rzvy-addons-singleqty-items li label{
			border: 1px solid <?php echo $cs_bfls_pcolor;?>;
		}
		.rzvy-mb .rzvy-addons-multipleqty-counter{
			border-right: 1px solid <?php echo $cs_bfls_pcolor;?>;
			border-left: 1px solid <?php echo $cs_bfls_pcolor;?>;
