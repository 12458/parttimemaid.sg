...
if(!isset($_SESSION['login_type'])) { 
	...
	if(!isset($rzvy_rolepermissions) || (sizeof($rzvy_rolepermissions)==0)){	
	?>
	<script>
...
if(!isset($_SESSION['admin_id']) && sizeof($rzvy_rolepermissions)==0) { 
	?>
	<script>
	window.location.href = "<?php echo SITE_URL; ?>backend/";
	</script>
...
<head>
	...
	<?php if (strpos($_SERVER['SCRIPT_NAME'], 'dashboard.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'advance-schedule.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'advance-schedule-breaks.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'pos.php') != false) { ?>
      ...
      <!-- Agency -->
			...
			<li>
				<a href="agency.php">
				  ...
				  <span class="rzvy_menubar_nav_name">Agency</span>
				</a>
				<span class="rzvy_menubar_nav_tooltip">Agency</span>
			</li>
      ...
      <!-- News -->
			...
			<li>
				<a href="news.php">
				  ...
				  <span class="rzvy_menubar_nav_name">News</span>
				</a>
				<span class="rzvy_menubar_nav_tooltip">News</span>
			</li>
