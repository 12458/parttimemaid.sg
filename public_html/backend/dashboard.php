		...
		<div class="card card-stats mb-4 mb-xl-0">
			<div class="card-body">
			  ...
			  <p class="mt-3 mb-0 text-muted text-sm">										
				<span class="text-wrap h2 font-weight-bold mb-0"><?php $count_of_total_revenue = $obj_dashboard->get_count_of_total_revenue(); if($count_of_total_revenue>0){ echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol,$rzvy_currency_position,@number_format($count_of_total_revenue,2)); }else{ echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol,$rzvy_currency_position,"0"); } ?></span>
			  </p>
			</div>
		</div>
	</div>
	<div class="<?php echo $rzvy_cards_width_class; ?> col-md-6 col-sm-6 mb-3">
		<div class="card card-stats mb-4 mb-xl-0">
			<div class="card-body">
			  <div class="row">
				<div class="col">
				  <h5 class="card-title text-muted mb-0"><?php if(isset($rzvy_translangArr['total_appointments'])){ echo $rzvy_translangArr['total_appointments']; }else{ echo $rzvy_defaultlang['total_appointments']; } ?></span>
				</div>
				<div class="col-auto">
				  <div class="icon icon-shape bg-primary text-white rounded-circle shadow rzvy-card-icon-css d-flex justify-content-center">
					<i class="fa fa-calendar fa-2x"></i>
				  </div>
				</div>
			  </div>
			  <p class="mt-3 mb-0 text-muted text-sm">										
				<span class="text-wrap h2 font-weight-bold mb-0"><?php echo $obj_dashboard->get_count_of_all_appointments(); ?></span>
			  </p>
			</div>
		</div>
	</div>
	...
	<div class="<?php echo $rzvy_cards_width_class; ?> col-md-6 col-sm-6 mb-3">
		<div class="card card-stats mb-4 mb-xl-0">
			<div class="card-body">
			  <div class="row">
				<div class="col">
				  <h5 class="card-title text-muted mb-0"><?php if(isset($rzvy_translangArr['registered_customers'])){ echo $rzvy_translangArr['registered_customers']; }else{ echo $rzvy_defaultlang['registered_customers']; } ?></span>
				</div>
				<div class="col-auto">
				  <div class="icon icon-shape bg-warning text-white rounded-circle shadow rzvy-card-icon-css d-flex justify-content-center">
					<i class="fa fa-users fa-2x"></i>
				  </div>
				</div>
			  </div>
			  <p class="mt-3 mb-0 text-muted text-sm">										
				<span class="text-wrap h2 font-weight-bold mb-0"><?php echo $obj_dashboard->get_count_of_all_registered_customers(); ?></span>
			  </p>
			</div>
		</div>
	</div>
	...
	<div class="<?php echo $rzvy_cards_width_class; ?> col-md-6 col-sm-6 mb-3">
		<div class="card card-stats mb-4 mb-xl-0">
			<div class="card-body">
			  <div class="row">
				<div class="col">
				  <h5 class="card-title text-muted mb-0"><?php if(isset($rzvy_translangArr['guest_customers'])){ echo $rzvy_translangArr['guest_customers']; }else{ echo $rzvy_defaultlang['guest_customers']; } ?></span>
				</div>
				<div class="col-auto">
				  <div class="icon icon-shape bg-info text-white rounded-circle shadow rzvy-card-icon-css d-flex justify-content-center">
					<i class="fa fa-users fa-2x"></i>
				  </div>
				</div>
			  </div>
			  <p class="mt-3 mb-0 text-muted text-sm">										
				<span class="text-wrap h2 font-weight-bold mb-0"><?php echo $obj_dashboard->get_count_of_all_guest_customers(); ?></span>
			  </p>
			</div>
		</div>
	</div>
