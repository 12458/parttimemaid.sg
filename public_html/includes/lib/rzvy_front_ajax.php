    ...
    if (mysqli_num_rows($all_services) > 0) {
        ...
        ?>
            <div class="services <?php echo $rzvyrounded; ?>">
                <!--<div class="owl-carousel" data-items="3" data-items-lg="3" data-items-md="2" data-items-sm="2" data-items-ssm="1" data-margin="24" data-dots="true" data-nav="true" autoplay="false"  autoplay="false" data-loop="false">-->
                <div class="row">
                    ...
                    while ($service = mysqli_fetch_array($all_services)) {
                        ...
                        if (isset($service['locations']) && $service['locations'] != '' && $rzvy_location_selector_status == 'Y') {
                            ...
                            if (isset($_SESSION['rzvy_location_selector_zipcode']) && !in_array($_SESSION['rzvy_location_selector_zipcode'], $service_locations)) {
                                $nonlocation_services++;
                                continue;
                            }
                        }
                        if ($rzvy_services_listing_view == "L") {
                                ...
                                <div class="rzvy-listview-list-data">
                                    ...
                                    if ($rzvy_show_service_image == "Y") {
                                        ...
                                        <div class="rzvy-listview-list-image">
                                            <img style="width: inherit;" src="<?php
                                            if ($service['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $service['image'])) {
                                                echo SITE_URL . "uploads/images/" . $service['image'];
                                            } else {
                                                echo SITE_URL . "includes/images/noimage.png";
                                            }
                                            ?>" />
                                        </div>
                                        <?php
                                    ...
                                    <div class="rzvy-listview-list-info px-1">
                                        <div class="rzvy-listview-list-title">
                                            ...
                                            if ($service['duration'] > 0) {
                                                ?><span class="rzvy-listview-list-price"><i class="fa fa-clock-o"></i> <?php echo round($service['duration'] / 60, 2) . " Hrs."; ?></span><?php
                                            }
                                    ...
                                    <div class="rzvy-listview-list-badge-main">
                                        <?php if ($service['badge'] == "Y") { ?>
                                            <div class="rzvy-listview-list-badge"><?php echo $service['badge_text']; ?>
                                                <?php echo $service['recurring_mode'] ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            ?>
                            <div class="item col-lg-4 col-md-6 col-sm-12" style="padding-bottom: calc(var(--bs-gutter-x) * .5)">
                            <!--<div class="item">-->
                                <figure>
                                    <?php
                                    $rzvyptclass = '';
                                    if ($rzvy_show_service_image == "Y") {
                                        ...
                                        ?>"><?php
                                             ...
                                             $rzvyptclass = 'rzvy-pt-figcaption';
                                         }
                                         ?>
                                    <figcaption class="<?php echo $rzvyptclass; ?>">
                                        <?php if ($service['badge'] == "Y") { ?>
                                            <span class="tag" style="margin-bottom:0px !important"><?php echo $service['badge_text']; ?></span>
                                            <?php echo $service['recurring_mode'] ?>
                                        <?php } ?>                   
                                        <h3><?php echo ucwords($service["title"]); ?></h3>
                                        <?php if ($service['description'] != "") { ?>
                                            <p><?php
                                                if (strlen($service['description']) <= 45) {
                                                    echo $service['description'] . "...";
                                                } else {
                                                    echo substr(ucwords($service['description']), 0, 45) . "...";
                                                }
                                                ?></p>
                                        <?php } ?>
                                        <div class="service-meta">
                                            <?php if ($service['duration'] > 0) { ?>
                                                <span class="<?php echo ($service['rate'] > 0 && $rzvy_price_display == 'Y') ? "pull-left" : "text-center"; ?>"><i class="fa fa-clock-o"></i> 
                                                    <label style="font-size:18px;font-weight:400"><?php echo round($service['duration'] / 60, 2) . " Hrs."; ?></label>
                                                </span>
                                            <?php } if ($rzvy_price_display == 'Y') { ?>
                                                <span class="<?php echo ($service['duration'] > 0) ? "pull-right" : "text-center"; ?>"><i class="fa fa-tag"></i> <?php
                                                    if ($service['rate'] > 0) {
                                                        ?>
                                                        <label>
                                                            <?php
                                                        ...
                                                        if (isset($rzvy_translangArr['free'])) {
                                                            echo $rzvy_translangArr['free'];
                                                        } else {
                                                            echo $rzvy_defaultlang['free'];
                                                        }
                                                    }
                                                    ?></span>
                                            <?php } ?>
                                        ...
                                        <a href="javascript:void(0);" class="read-more" data-bs-toggle="offcanvas" data-bs-target="#rzvy-view-service-modal-<?php echo $service['id']; ?>" aria-controls="<?php echo ucwords($service["title"]); ?>"><?php
                                            if (isset($rzvy_translangArr['read_more'])) {
                                                echo $rzvy_translangArr['read_more'];
                                            } else {
                                                echo $rzvy_defaultlang['read_more'];
                                            }
                                            ?></a>
                                    </figcaption>
                                </figure>
...
//                            print_r($service);
                            ...
                            <h2><?php echo $service['recurring_mode']; ?></h2>
                            <p><?php echo ucfirst($service['description']); ?></p>
                            <div class="service-meta">
                                <?php if ($rzvy_price_display == 'Y') { ?> <span><i class="fa fa-fw fa-money"></i>&nbsp;&nbsp;<strong><?php
                                    if (isset($rzvy_translangArr['rate_ad'])) {
                                        echo $rzvy_translangArr['rate_ad'];
                                    } else {
                                        echo $rzvy_defaultlang['rate_ad'];
                                    }
                                    ?></strong>&nbsp;<?php echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $service['rate']); ?>	</span><?php } ?>
                                <span><i class="fa fa-fw fa-clock-o"></i>&nbsp;&nbsp;<strong><?php
                                        if (isset($rzvy_translangArr['duration_ad'])) {
                                            echo $rzvy_translangArr['duration_ad'];
                                        } else {
                                            echo $rzvy_defaultlang['duration_ad'];
                                        }
                                        ?></strong>&nbsp;<?php echo round($service['duration']/60,2) . " Hrs"; ?></span>
                                <span><i class="fa fa-fw fa-map-marker"></i>&nbsp;&nbsp;<strong><?php
                                        if (isset($rzvy_translangArr['service_locations'])) {
                                            echo $rzvy_translangArr['service_locations'];
                                        } else {
                                            echo $rzvy_defaultlang['service_locations'];
                                        }
                                        ?> </strong>&nbsp;<?php
                                    if (isset($service['locations']) && $service['locations'] != '') {
                                        ...
                                        if (isset($rzvy_translangArr['all_over'])) {
                                            ...
                                            echo $rzvy_defaultlang['all_over'];
                                        }
                                    }
                                    ?></span>	
                            </div>
            ...
            if ($nonlocation_services == mysqli_num_rows($all_services)) {
                ?>
                <h5 class="step-title"><?php
                    if (isset($rzvy_translangArr['there_is_no_services_for_this_location'])) {
                        echo $rzvy_translangArr['there_is_no_services_for_this_location'];
                    } else {
                        echo $rzvy_defaultlang['there_is_no_services_for_this_location'];
                    }
                    ?></h5>
                <?php
            }
            if ($rzvy_services_listing_view == "L") {
                ...
                ?>
                <h5 class="step-title"><?php
                    if (isset($rzvy_translangArr['there_is_no_services_for_this_category'])) {
                        echo $rzvy_translangArr['there_is_no_services_for_this_category'];
                    } else {
                        echo $rzvy_defaultlang['there_is_no_services_for_this_category'];
                    }
                    ?></h5>
                <?php
            }
        ...
        /* get addons by service id ajax */ else if (isset($_POST['get_multi_and_single_qty_addons_content'])) {
            /*             * * multiple qty addons * */
                ...
                <div id="rzvy_multipleqty_addon_html_content" class="rzvy_show_hide_addons pt-5 services <?php echo $alignmentClass; ?> <?php echo $rzvyrounded; ?>">
                    <div class="owl-carousel" data-items="3" data-items-lg="3" data-items-md="2" data-items-sm="2" data-items-ssm="1" data-margin="24" data-dots="true" data-nav="true"  autoplay="false"  autoplay="false" data-loop="false">
                        ...
                        while ($addon = mysqli_fetch_array($all_maddons)) {
                            ?>
                            <div class="item">
                                <input id="rzvy-addon-card-mnl-<?php echo $addon['id']; ?>" type="hidden" value="<?php
                                if ($addon["multiple_qty"] == "N" || $addon["max_limit"] == 1) {
                                    echo "1";
                                } else {
                                    echo $addon['min_limit'];
                                }
                                ?>" />
                                <input id="rzvy-addon-card-ml-<?php echo $addon['id']; ?>" type="hidden" value="<?php
                                if ($addon["multiple_qty"] == "N" || $addon["max_limit"] == 1) {
                                    echo "1";
                                } else {
                                    echo $addon['max_limit'];
                                }
                                ?>" />
                                <figure>
                                    <?php
                                    $rzvyptclass = '';
                                    if ($rzvy_show_addon_image == "Y") {
                                        ?><img src="<?php
                                        if ($addon['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $addon['image'])) {
                                            echo SITE_URL . "uploads/images/" . $addon['image'];
                                        } else {
                                            echo SITE_URL . "includes/images/noimage.png";
                                        }
                                        ?>" class="<?php
                                             if ($addon["multiple_qty"] == "Y" && $addon["max_limit"] > 1) {
                                                 echo " rzvy_make_multipleqty_addon_card_selected";
                                             }
                                             ?>" data-id="<?php echo $addon["id"]; ?>"><?php
                                         } else {
                                             $rzvyptclass = 'rzvy-pt-figcaption';
                                         }
                                         ?>
                                    <figcaption class="<?php echo $rzvyptclass; ?>">
                                        <?php if ($addon['badge'] == "Y") { ?>
                                            ...
                                            ?>" data-id="<?php echo $addon["id"]; ?>"><?php echo $addon['badge_text']; ?></span>
                                              <?php } ?>
                                        <h3 <?php
                                        if ($addon["multiple_qty"] == "Y" && $addon["max_limit"] > 1) {
                                            echo " rzvy_make_multipleqty_addon_card_selected";
                                        }
                                        ?>><?php echo ucwords($addon["title"]); ?></h3>
                                            ...
                                            ?>" data-id="<?php echo $addon["id"]; ?>"><?php
                                                   if (strlen($addon['description']) <= 45) {
                                                       echo $addon['description'] . "...";
                                                   } else {
                                                       echo substr(ucwords($addon['description']), 0, 45) . "...";
                                                   }
                                                   ?></p>
                                        <?php } ?>
                                        <div class="service-meta <?php
                                        if ($addon["multiple_qty"] == "Y" && $addon["max_limit"] > 1) {
                                            echo " rzvy_make_multipleqty_addon_card_selected";
                                        }
                                        ?>" data-id="<?php echo $addon["id"]; ?>">
                                            <?php if ($addon['duration'] > 0) { ?><span class="<?php echo ($addon['rate'] > 0 && $rzvy_price_display == 'Y') ? "pull-left" : "text-center"; ?>"><i class="fa fa-clock-o"></i> <?php echo round($addon['duration'] / 60, 2) . " Hrs."; ?></span><?php } if ($rzvy_price_display == 'Y') { ?><span class="<?php echo ($addon['duration'] > 0) ? "pull-right" : "text-center"; ?>"><i class="fa fa-tag"></i> <?php
                                                if ($addon['rate'] > 0) {
                                                    echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $addon['rate']);
                                                } else {
                                                    if (isset($rzvy_translangArr['free'])) {
                                                        echo $rzvy_translangArr['free'];
                                                    } else {
                                        ...
                                        <?php } ?>
                                        <a href="javascript:void(0);" class="read-more" data-bs-toggle="offcanvas" data-bs-target="#rzvy-view-addon-modal-<?php echo $addon['id']; ?>" aria-controls="<?php echo ucwords($addon["title"]); ?>"><?php
                                            if (isset($rzvy_translangArr['read_more'])) {
                                                echo $rzvy_translangArr['read_more'];
                                            } else {
                                                echo $rzvy_defaultlang['read_more'];
            ...
            if ($maddons_count > 0) {
                while ($addon = mysqli_fetch_array($all_maddons)) {
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="rzvy-view-addon-modal-<?php echo $addon["id"]; ?>">
                        ...
                        <div class="offcanvas-body">
                            <?php if ($rzvy_show_addon_image == "Y") { ?><img src="<?php
                                if ($addon['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $addon['image'])) {
                                    echo SITE_URL . "uploads/images/" . $addon['image'];
                                } else {
                                    echo SITE_URL . "includes/images/noimage.png";
                            ...
                            <div class="service-meta">
                                <?php if ($rzvy_price_display == 'Y') { ?><span><i class="fa fa-fw fa-money"></i>&nbsp;&nbsp;<strong><?php
                                    ...
                                    ?> </strong><?php echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $addon['rate']); ?></span><?php } ?>
                                ...
                                <span><i class="fa fa-fw fa-clock-o"></i>&nbsp;&nbsp;<strong><?php
                                        ...
                                        ?> </strong><?php echo $addon['duration'] . " Minutes"; ?></span>
                            </div>
                        </div>
                    </div>
                    <?php
        ...
        /* get all frequently discount */ else if (isset($_POST['get_all_frequently_discount'])) {
                            ...
                            while ($fd_discount = mysqli_fetch_array($all_frequently_discount)) {
                                ...
                                <div class="col-sm-6">
                                    <div class="form-check custom">
                                        ...
                                        <label class="form-check-label" for="rzvy-frequently-discount-<?php echo $fd_discount['id']; ?>" <?php
                                        if ($fd_discount['fd_description'] != "") {
                                            echo ' data-toggle="tooltip" data-placement="bottom" title="' . $fd_discount['fd_description'] . '"';
                                        }
                                        ?>><?php
                                                   if ($fd_discount['fd_key'] == "weekly") {
                                                       echo $fq_weekly_label;
                                                   } else if ($fd_discount['fd_key'] == "bi weekly") {
                                                       echo $fq_biweekly_label;
                                                   } else if ($fd_discount['fd_key'] == "monthly") {
                                                       echo $fq_monthly_label;
                                                   } else {
                                                       echo $fq_one_time_label;
                                                   }
                                                   ?></label>
                                    </div>
                                </div>
        ...
        /* on change update frequently discount */ else if (isset($_POST['update_frequently_discount'])) {
            $rzvy_tax_status = $obj_settings->get_option('rzvy_tax_status');
            $rzvy_tax_type = $obj_settings->get_option('rzvy_tax_type');
            $rzvy_tax_value = $obj_settings->get_option('rzvy_tax_value');
        ...
        /* Check and apply coupon ajax */ else if (isset($_POST['apply_coupon'])) {
            $rzvy_tax_status = $obj_settings->get_option('rzvy_tax_status');
            $rzvy_tax_type = $obj_settings->get_option('rzvy_tax_type');
            $rzvy_tax_value = $obj_settings->get_option('rzvy_tax_value');
            $subtotal = $_SESSION['rzvy_cart_subtotal'];
            if ($subtotal > 0) {
                ...
                if ($couponinfo != '') {
                    ...
                    if ($couponinfo['usage'] == 'M' && $couponuser != '' && (is_numeric(strpos($couponinfo['users'], 'A')) || is_numeric(strpos($couponinfo['users'], $couponuser)))) {
                        ...
                        if (isset($_SESSION['customer_id']) && $_SESSION['customer_id'] != '') {
                            ...
                            if ($obj_frontend->check_available_coupon_of_existing_customer() == 'not used') {
                                ...
                                $errorcheck = 'Y';
                                if (isset($rzvy_translangArr['coupon_code_already_used'])) {
                                    echo $rzvy_translangArr['coupon_code_already_used'];
                                } else {
                                    echo $rzvy_defaultlang['coupon_code_already_used'];
                                }
                            }
                        } else {
                            $errorcheck = 'Y';
                            if (isset($rzvy_translangArr['you_must_login_to_use_this_cc'])) {
                                echo $rzvy_translangArr['you_must_login_to_use_this_cc'];
                            } else {
                                echo $rzvy_defaultlang['you_must_login_to_use_this_cc'];
                            }
                        }
                    ...
                    if ($couponcheck == '' && $errorcheck == '') {
                        if (isset($rzvy_translangArr['invalid_coupon_code_you_not_allowed'])) {
                            echo $rzvy_translangArr['invalid_coupon_code_you_not_allowed'];
                        } else {
                            echo $rzvy_defaultlang['invalid_coupon_code_you_not_allowed'];
                        }
                    }
                } else {
                    if (isset($rzvy_translangArr['coupon_code_invalid_expired'])) {
                        echo $rzvy_translangArr['coupon_code_invalid_expired'];
                    } else {
                        echo $rzvy_defaultlang['coupon_code_invalid_expired'];
                    }
                }
            } else {
                if (isset($rzvy_translangArr['copuon_cannot_apply_to_empty_cart_value'])) {
                    echo $rzvy_translangArr['copuon_cannot_apply_to_empty_cart_value'];
                } else {
                    echo $rzvy_defaultlang['copuon_cannot_apply_to_empty_cart_value'];
                }
            }
        }

        /* remove applied coupon ajax */ else if (isset($_POST['remove_applied_coupon'])) {
            $rzvy_tax_status = $obj_settings->get_option('rzvy_tax_status');
            $rzvy_tax_type = $obj_settings->get_option('rzvy_tax_type');
            $rzvy_tax_value = $obj_settings->get_option('rzvy_tax_value');
            $subtotal = $_SESSION['rzvy_cart_subtotal'];
        ...
        /* add feedback ajax */ else if (isset($_POST['add_feedback'])) {
        ...
        /* Check feedback exist ajax */ else if (isset($_POST['check_feedback_exist'])) {
        ...
        /* Get available slots ajax */ else if (isset($_POST['get_slots'])) {
            $rzvy_settings_timezone = $obj_settings->get_option("rzvy_timezone");
            $rzvy_server_timezone = date_default_timezone_get();
            $currDateTime_withTZ = $obj_settings->get_current_time_according_selected_timezone($rzvy_server_timezone, $rzvy_settings_timezone);
            ...
            <div class="pt-1 pb-1 pl-4 pr-4 whitebox">
                <div class="row">
                    <div class="col-md-12 rzvy-sm-box mb-1">
                        <a href="javascript:void(0);" class="rzvy_back_to_calendar"><i class="fa fa-caret-up fa-2x"></i> <?php
                            if (isset($rzvy_translangArr['reset_date'])) {
                                echo $rzvy_translangArr['reset_date'];
                            } else {
                                echo $rzvy_defaultlang['reset_date'];
                            }
                            ?></a>
                        <a href="javascript:void(0);" class="rzvy_reset_slot_selection pull-right" data-day="<?php echo $selected_date; ?>"><i class="fa fa-refresh"></i> <?php
                            if (isset($rzvy_translangArr['reset_slots'])) {
                                echo $rzvy_translangArr['reset_slots'];
                            } else {
                                echo $rzvy_defaultlang['reset_slots'];
                            }
                            ?></a>
                    </div>
                </div>
                ...
                <div class="row slot_refresh_div">
                    ...
                    if (strtotime($selected_date) > strtotime($maximum_date)) {
                        ...
                        <div class="col-md-12 rzvy-sm-box rzvy_slot_new mb-2 text-center pt-3">
                            <h6><?php
                                if (isset($rzvy_translangArr['you_cannot_book_appointment_on'])) {
                                    echo $rzvy_translangArr['you_cannot_book_appointment_on'];
                                } else {
                                    echo $rzvy_defaultlang['you_cannot_book_appointment_on'];
                                }
                                ?> <?php echo date($rzvy_date_format, strtotime($selected_date)); ?>. <?php
                                if (isset($rzvy_translangArr['our_maximum_advance_booking_period_is'])) {
                                    echo $rzvy_translangArr['our_maximum_advance_booking_period_is'];
                                } else {
                                    echo $rzvy_defaultlang['our_maximum_advance_booking_period_is'];
                                }
                                ?> <?php
                                if ($rzvy_maximum_advance_booking_time == "1") {
                                    echo "1 Month";
                                } else if ($rzvy_maximum_advance_booking_time == "3") {
                                    echo "3 Month";
                                } else if ($rzvy_maximum_advance_booking_time == "6") {
                                    echo "6 Month";
                                } else if ($rzvy_maximum_advance_booking_time == "9") {
                                    echo "9 Month";
                                } else if ($rzvy_maximum_advance_booking_time == "12") {
                                    echo "1 Year";
                                } else if ($rzvy_maximum_advance_booking_time == "18") {
                                    echo "1.5 Year";
                                } else if ($rzvy_maximum_advance_booking_time == "24") {
                                    echo "2 Year";
                                }
                                ?>. <?php
                                if (isset($rzvy_translangArr['so_you_can_book_appointment_till'])) {
                                    echo $rzvy_translangArr['so_you_can_book_appointment_till'];
                                } else {
                                    echo $rzvy_defaultlang['so_you_can_book_appointment_till'];
                                }
                                ?> <?php echo $maximum_date; ?></h6>
                        </div>
                        <?php
                    }
                    /** time slots * */ else if (isset($available_slots['slots']) && sizeof($available_slots['slots']) > 0) {
                        $i = 1;
                        $j = 0;
                        ...
                        if ($j == 0) {
                            ...
                            <div class="col-md-12 rzvy-sm-box rzvy_slot_new col-md-12 rzvy-sm-box mb-2 text-center pt-3">
                                <h6><?php
                                    if (isset($rzvy_translangArr['none_of_slots_available_on'])) {
                                        echo $rzvy_translangArr['none_of_slots_available_on'];
                                    } else {
                                        echo $rzvy_defaultlang['none_of_slots_available_on'];
                                    }
                                    ?> <?php echo date($rzvy_date_format, strtotime($selected_date)); ?></h6>
                            </div>
                            <?php
                        }
                    } else {
        ...
        /* Endtime available slots ajax */ else if (isset($_POST['get_endtime_slots'])) {
            $rzvy_settings_timezone = $obj_settings->get_option("rzvy_timezone");
            $rzvy_server_timezone = date_default_timezone_get();
            $currDateTime_withTZ = $obj_settings->get_current_time_according_selected_timezone($rzvy_server_timezone, $rzvy_settings_timezone);
            ...
            <div class="pt-1 pb-1 pl-4 pr-4 whitebox">
                <div class="row">
                    <div class="col-md-12 rzvy-sm-box mb-1 text-center">
                        ...
                        <a href="javascript:void(0);" class="rzvy_reset_slot_selection pull-right" data-day="<?php echo $selected_date; ?>"><label><b><i class="fa fa-refresh"></i> <?php
                                    if (isset($rzvy_translangArr['reset'])) {
                                        echo $rzvy_translangArr['reset'];
                                    } else {
                                        echo $rzvy_defaultlang['reset'];
                                    }
                                    ?></b></label></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 rzvy-sm-box mb-3 text-center">
                        ...
                        <br/>
                        <label><b><?php
                                if (isset($rzvy_translangArr['from'])) {
                                    echo $rzvy_translangArr['from'];
                                } else {
                                    echo $rzvy_defaultlang['from'];
                                }
                                ?>: <i class="fa fa-clock-o"></i> <?php echo date($rzvy_time_format, strtotime($selected_date . " " . $_POST["selected_slot"])); ?></b></label>
                    </div>
                </div>
                <div class="row">
                    <?php
                            ...
                            if ($no_booking != 0 && $no_curr_boookings >= $no_booking) {
                                ...
                                <div class="col-md-12 rzvy-sm-box rzvy_slot_new">
                                    <label><b>[ <?php
                                            ...
                                            ?> <?php echo date($rzvy_date_format, strtotime($selected_date)); ?>. ]</b></label>
                                </div>
                                <?php
                            } else {
                                ?>
        ...
        /* Add selected slot to session ajax */ else if (isset($_POST['add_selected_slot'])) {
        ...
        /* Add selected slot to session ajax */ else if (isset($_POST['add_selected_slot_withendslot'])) {
            if (is_numeric($_SESSION['rzvy_cart_service_id']) && $_SESSION['rzvy_cart_service_id'] != "0") {
                $time_interval = $obj_slots->get_service_time_interval($_SESSION['rzvy_cart_service_id'], $time_interval);
        ...
        /* Frontend login ajax */ else if (isset($_POST['front_login'])) {
        ...
        /* Frontend logout ajax */ else if (isset($_POST['front_logout'])) {
        ...
        /* Get available coupons for customer ajax */ else if (isset($_POST['remove_applied_rcoupon'])) {
            $_SESSION["rzvy_applied_ref_customer_id"] = '';
            $rzvy_tax_status = $obj_settings->get_option('rzvy_tax_status');
            $rzvy_tax_type = $obj_settings->get_option('rzvy_tax_type');
            $rzvy_tax_value = $obj_settings->get_option('rzvy_tax_value');
        ...
        /* Get available coupons for customer ajax */ else if (isset($_POST['get_available_rcoupons'])) {
            $_SESSION["rzvy_applied_ref_customer_id"] = '';
            $rzvy_tax_status = $obj_settings->get_option('rzvy_tax_status');
            $rzvy_tax_type = $obj_settings->get_option('rzvy_tax_type');
            $rzvy_tax_value = $obj_settings->get_option('rzvy_tax_value');
        ...
        /* Get available coupons for customer ajax */ else if (isset($_POST['get_available_coupons'])) {
            ...
            <h2 class="fs-5 pt-3"><?php
                ...
                ?>: <?php echo date($rzvy_date_format, strtotime($coupon['select_a_promo_offer'])); ?></h2>
            <div class="rzvy-table">
                <table class="table">
                    <thead>
                        <tr>
                            <th><?php
                                ...
                                ?>: <?php echo date($rzvy_date_format, strtotime($coupon['coupon_value'])); ?></th>
                            <th align="left"><?php
                                if (isset($rzvy_translangArr['coupon_code'])) {
                                    echo $rzvy_translangArr['coupon_code'];
                                } else {
                                ...
                                ?>: <?php echo date($rzvy_date_format, strtotime($coupon['coupon_code'])); ?></th>
                            <th align="left"><?php
                                ...
                                ?>: <?php echo date($rzvy_date_format, strtotime($coupon['coupon_expiry'])); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <div class="row rzvy-available-coupons-list <?php echo $inputAlignment; ?>">
                            ...
                            <label class="col-md-11 rzvy-coupon-radio-label" for="rzvy-coupon-radio-<?php echo $coupon['id']; ?>">
                                <div class="rzvy-coupons-container-label">
                                    <?php if ($coupon['coupon_type'] == "flat") { ?>
                                        <h6><b><?php
                                                ...
                                                ?> <?php echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $coupon['coupon_value']); ?> <?php
                                                if (isset($rzvy_translangArr['off_on_your_purchase'])) {
                                                    echo $rzvy_translangArr['off_on_your_purchase'];
                                                } else {
                                                    echo $rzvy_defaultlang['off_on_your_purchase'];
                                                ...
                                                ?></b></h6> 
                                    <?php } else { ?>
                                        <h6><b><?php echo $coupon['coupon_value']; ?>% <?php
                                                if (isset($rzvy_translangArr['off_on_your_purchase'])) {
                                                    echo $rzvy_translangArr['off_on_your_purchase'];
                                                } else {
                                                    echo $rzvy_defaultlang['off_on_your_purchase'];
                                ...
                                <div class="rzvy-coupons-container">
                                    <div><?php
                                        if (isset($rzvy_translangArr['use_promo_code'])) {
                                            echo $rzvy_translangArr['use_promo_code'];
                                        } else {
                                            echo $rzvy_defaultlang['use_promo_code'];
                                        }
                                        ?>: <span class="rzvy-coupons-code-label"><?php echo $coupon['coupon_code']; ?></span></div>
                                    <div class="rzvy-coupons-code-expire-label"><?php
                                        if (isset($rzvy_translangArr['expires'])) {
                                            echo $rzvy_translangArr['expires'];
                                        } else {
                                            echo $rzvy_defaultlang['expires'];
                                        }
                                        ?>: <?php echo date($rzvy_date_format, strtotime($coupon['coupon_expiry'])); ?></div>
                                </div>
                            </label>
                        </div>
                        <?php
                                    ...
                                    <div class="row rzvy-available-rcoupons-list">
                                        ...
                                        <label class="col-md-11 rzvy-rcoupon-radio-label" for="rzvy-rcoupon-radio-<?php echo $coupon['id']; ?>">
                                            <div class="rzvy-rcoupons-container-label">
                                                <?php if ($coupon['discount_type'] == "flat") { ?>
                                                    <h6><b><?php
                                                            ...
                                                            ?> <?php echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $coupon['discount']); ?> <?php
                                                            if (isset($rzvy_translangArr['off_on_your_purchase'])) {
                                                                echo $rzvy_translangArr['off_on_your_purchase'];
                                                            } else {
                                                                echo $rzvy_defaultlang['off_on_your_purchase'];
                                                            ...
                                                            ?></b></h6> 
                                                <?php } else { ?>
                                                    <h6><b><?php echo $coupon['discount']; ?>% <?php
                                                            if (isset($rzvy_translangArr['off_on_your_purchase'])) {
                                                                echo $rzvy_translangArr['off_on_your_purchase'];
                                                            } else {
                                                                echo $rzvy_defaultlang['off_on_your_purchase'];
                                            ...
                                            <div class="rzvy-rcoupons-container">
                                                <div><?php
                                                    if (isset($rzvy_translangArr['use_referral_promo_code'])) {
                                                        echo $rzvy_translangArr['use_referral_promo_code'];
                                                    } else {
                                                        echo $rzvy_defaultlang['use_referral_promo_code'];
                                                    }
                                                    ?>: <span class="rzvy-rcoupons-code-label"><?php echo $coupon['coupon']; ?></span></div>
                                            </div>
                                        </label>
                                    </div>
                                    <?php
        ...
        /** Check Referal code Ajax * */ else if (isset($_POST["apply_referral_code"])) {
        ...
        /** Remove Referal code Ajax * */ else if (isset($_POST["remove_referral_code"])) {
            $_SESSION['rzvy_ref_customer_id'] = "";
            $_SESSION["referralcode_applied"] = "N";
            $_SESSION["rzvy_applied_ref_customer_id"] = "";
            $_SESSION["rzvy_applied_refcode"] = "";
        ...
        /* cart: apply referral discount coupon */ else if (isset($_POST['apply_referral_discount'])) {
        ...
        /** Set selected language Ajax * */ else if (isset($_POST["set_selected_language"])) {
        ...
        /** Get staff according to service selection */ else if (isset($_POST["get_staff_according_service"])) {
            $service_id = $_POST['id'];
            ...
            if ($servicelinkedstaffs > 0) {
                ?>
                <div class="step-item">
                    <h2 class="step-title <?php echo $inputAlignment; ?>"><?php
                        if (isset($rzvy_translangArr['choose_staff_member'])) {
                            echo $rzvy_translangArr['choose_staff_member'];
                        } else {
                            echo $rzvy_defaultlang['choose_staff_member'];
                        }
                        ?></h2>

                    <?php
                    if ($servicelinkedstaffs > 1) {
                                ...
                                <div class="col-md-<?php echo $rzvy_colmdclass; ?> py-2">
                                    <div class="card rzvy_card_common  <?php echo $inputAlignment; ?> rzvy-staff-change rzvy-staff-change-tt" id="rzvy-staff-change-id-today" data-id="today" data-sdate="<?php echo date('Y-m-d'); ?>">
                                        <div class="card-body p-1 <?php echo $insideContentAlignment; ?>">
                                            <h5 class="card-text pb-2 pt-2"><?php
                                                if (isset($rzvy_translangArr['available_today'])) {
                                                    echo $rzvy_translangArr['available_today'];
                                                } else {
                                                    echo $rzvy_defaultlang['available_today'];
                                                }
                                                ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <?php if ($rzvy_staffs_time_tomorrow != 'Y') { ?>
                                </div>	
                                <?php
                            }
                        }
                            ...
                            if ($rzvy_staffs_time_today != 'Y') {
                                ...
                                <div class="col-md-<?php echo $rzvy_colmdclass; ?> py-2">
                                    <div class="card rzvy_card_common  <?php echo $inputAlignment; ?> rzvy-staff-change rzvy-staff-change-tt" id="rzvy-staff-change-id-tomorrow" data-id="tomorrow" data-sdate="<?php echo date('Y-m-d', strtotime('+1 days')); ?>">
                                        <div class="card-body p-1 <?php echo $insideContentAlignment; ?>">
                                            <h5 class="card-text pb-2 pt-2"><?php
                                                if (isset($rzvy_translangArr['available_tomorrow'])) {
                                                    echo $rzvy_translangArr['available_tomorrow'];
                                                } else {
                                                    echo $rzvy_defaultlang['available_tomorrow'];
                                                }
                                                ?></h5>
                                        </div>
                                    </div>
                    ...
                    <div class="services team <?php echo $alignmentClass; ?> <?php echo $rzvyrounded; ?>">
                        <div class="owl-carousel" data-items="3" data-items-lg="2" data-items-md="2" data-items-sm="2" data-items-ssm="1" data-margin="24" data-nav="true" data-dots="true"  autoplay="false" data-loop="false">
                            ...
                            while ($staffid = mysqli_fetch_array($getall_service_staffid)) {
                                ...
                                $reviewlabel = '';
                                if (isset($rzvy_translangArr['reviews'])) {
                                    $reviewlabel = $rzvy_translangArr['reviews'];
                                } else {
                                    $reviewlabel = $rzvy_defaultlang['reviews'];
                                }
                                ...
                                <div class="item">
                                    <figure>
                                        ...
                                        if ($rzvy_show_staff_image == "Y") {
                                            ?><img src="<?php
                                            if ($staffdata['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $staffdata['image'])) {
                                                echo SITE_URL . "uploads/images/" . $staffdata['image'];
                                            } else {
                                                echo SITE_URL . "includes/images/noimage.png";
                                            }
                                            ?>"><?php
                                        ...
                                        <figcaption class="<?php echo $rzvyptclass; ?>">
                                            ...
                                            <div class="service-meta">
                                                <?php if ($show_completed_jobs_on_booking_form == "Y") { ?><span><i class="fa fa-fw fa-check-square-o" aria-hidden="true"></i> <?php
                                                    if (isset($rzvy_translangArr['completed_jobs'])) {
                                                        echo $rzvy_translangArr['completed_jobs'];
                                                    } else {
                                                        echo $rzvy_defaultlang['completed_jobs'];
                                                    }
                                                    ?> : <?php echo $job_completed; ?></span><?php } ?>
        ...
        /** Set staff id in session on selection */ else if (isset($_POST["set_staff_according_service"])) {
        ...
        /** Check Referal code Ajax * */ else if (isset($_POST["apply_loyalty_point"])) {
            ...
            if ($total_cat > 0) {
                ?>
                <div class="services <?php echo $rzvyrounded; ?>">
                    <div class="owl-carousel" data-items="3" data-items-lg="2" data-items-md="2" data-items-sm="2" data-items-ssm="1" data-margin="24" data-dots="true" data-nav="true"  autoplay="false" data-loop="false"><?php
                        while ($category = mysqli_fetch_array($all_categories)) {
                            ...
                            <div class="item">
                                <figure>
                                    <?php
                                    $rzvyptclass = '';
                                    if ($rzvy_show_category_image == "Y") {
                                        ?><img src="<?php
                                        if ($category['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $category['image'])) {
                                            echo SITE_URL . "uploads/images/" . $category['image'];
                                        } else {
                                            echo SITE_URL . "includes/images/noimage.png";
                                        }
                                        ?>"><?php
                ...
                <h5 class="step-title">
                    <?php
                    if (isset($rzvy_translangArr['please_configure_first_services_from_admin_area'])) {
                        echo $rzvy_translangArr['please_configure_first_services_from_admin_area'];
                    } else {
                        echo $rzvy_defaultlang['please_configure_first_services_from_admin_area'];
                    }
                    ?>
                </h5>
                <?php
                ...
                if ($rzvy_parent_category == "Y") {
                    ...
                    <div class="step-item <?php echo $alignmentClass; ?> rzvy-pcategory-container">
                        ...
                        if ($total_cat > 0) {
                            ...
                            <div class="step-title <?php echo $inputAlignment; ?>">
                                <?php
                                if (isset($rzvy_translangArr['choose_category_of_your_service'])) {
                                    echo $rzvy_translangArr['choose_category_of_your_service'];
                                } else {
                                    echo $rzvy_defaultlang['choose_category_of_your_service'];
                                }
                                ?>
                            </div>
                            <div class="services <?php echo $rzvyrounded; ?>">
                                <div class="owl-carousel" data-items="3" data-items-lg="3" data-items-md="3" data-items-sm="1" data-items-ssm="1" data-margin="24" data-dots="true" data-nav="true"  autoplay="false" data-loop="false">
                                    <?php
                                    while ($category = mysqli_fetch_array($all_categories)) {
                                        ?>
                                        <div class="item">
                                            <figure class="<?php echo $insideContentAlignment; ?>">
                                                <?php
                                                $rzvyptclass = '';
                                                if ($rzvy_show_parentcategory_image == "Y") {
                                                    ?><img src="<?php
                                                    if ($category['image'] != "" && file_exists(dirname(dirname(dirname(__FILE__))) . "/uploads/images/" . $category['image'])) {
                                                        echo SITE_URL . "uploads/images/" . $category['image'];
                                                    } else {
                    ...
                    <div class="step-item <?php echo $alignmentClass; ?>  rzvy-company-services-blocks rzvy_show_hide_sub_categories">
                        <h2 class="step-title <?php echo $inputAlignment; ?> rzvy_categories_html_content_scroll">
                            <?php
                            if (isset($rzvy_translangArr['what_type_of_service'])) {
                                echo $rzvy_translangArr['what_type_of_service'];
                            } else {
                                echo $rzvy_defaultlang['what_type_of_service'];
                            }
                            ?>
                        </h2>
                    ...
                    <div class="step-item <?php echo $alignmentClass; ?> rzvy_show_hide_services">
                        <h2 class="step-title <?php echo $inputAlignment; ?> ">
                            <?php
                            if (isset($rzvy_translangArr['tell_us_about_your_service'])) {
                                echo $rzvy_translangArr['tell_us_about_your_service'];
                            } else {
                                echo $rzvy_defaultlang['tell_us_about_your_service'];
                            }
                            ?>
                        </h2>
                    </div>
                    ...
                    ?>
                    <div class="hello2 step-item <?php echo $alignmentClass; ?> rzvy-company-services-blocks">
            <!--                        <h2 class="step-title <?php echo $inputAlignment; ?> rzvy_categories_html_content_scroll">
                        <?php
//                            if (isset($rzvy_translangArr['what_type_of_service'])) {
//                                echo $rzvy_translangArr['what_type_of_service'];
...
//                            }
                    ...
                    <div style="padding-top:0px !important" class="another-section step-item <?php echo $alignmentClass; ?> rzvy_show_hide_services">
                        <h2 class="step-title <?php echo $inputAlignment; ?>">
                            <?php
                            if (isset($rzvy_translangArr['tell_us_about_your_service'])) {
                                echo $rzvy_translangArr['tell_us_about_your_service'];
                ...
                <div class="rzvy-no-border-bottom rzvy-mb-minus2 rzvy_show_hide_services" style="display:block">
                    <div id="rzvy_services_html_content" class="<?php
                    if ($rzvy_services_listing_view != "L") {
                        echo $alignmentClass;
                    }
                    ?>">
                            ...
                            <div class="services <?php echo $rzvyrounded; ?>">
                                ...
                                if (mysqli_num_rows($all_services) > 0) {
                                    ?>
                                    <div class="owl-carousel" data-items="3" data-items-lg="3" data-items-md="2" data-items-sm="2" data-items-ssm="1" data-margin="24" data-dots="true" data-nav="true"  autoplay="false" data-loop="false"><?php
                                        while ($service = mysqli_fetch_array($all_services)) {
                                            if (isset($service['locations']) && $service['locations'] != '' && $rzvy_location_selector_status == 'Y') {
                                                $service_locations = explode(',', $service['locations']);
                                                if (isset($_SESSION['rzvy_location_selector_zipcode']) && !in_array($_SESSION['rzvy_location_selector_zipcode'], $service_locations)) {
                                                ...
                                                <div class="item">
                                                    <figure>
                                                        ...
                                                        <figcaption class="<?php echo $rzvyptclass; ?>">
                                                            ...
                                                            <?php } ?>
                                                            <div class="service-meta">
                                                                <?php if ($service['duration'] > 0) { ?><span class="<?php echo ($service['rate'] > 0 && $rzvy_price_display == 'Y') ? "pull-left" : "text-center"; ?>"><i class="fa fa-clock-o"></i> <?php echo round($service['duration'] / 60, 2) . " Hrs."; ?></span><?php } if ($rzvy_price_display == 'Y') { ?><span class="<?php echo ($service['duration'] > 0) ? "pull-right" : "text-center"; ?>"><i class="fa fa-tag"></i> <?php
                                                                    if ($service['rate'] > 0) {
                                                                        echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol, $rzvy_currency_position, $service['rate']);
                                                                    } else {
                                                                        if (isset($rzvy_translangArr['free'])) {
                                    ...
                                    if ($nonlocation_services == mysqli_num_rows($all_services)) {
                                        ?>
                                        <h5 class="step-title <?php echo $inputAlignment; ?>"><?php
                                            if (isset($rzvy_translangArr['there_is_no_services_for_this_location'])) {
                                                echo $rzvy_translangArr['there_is_no_services_for_this_location'];
                                            } else {
                                                echo $rzvy_defaultlang['there_is_no_services_for_this_location'];
                                    ...
                                    <div class="step-item">
                                        <h5 class="step-title <?php echo $inputAlignment; ?>">
                                            <?php
                                            if (isset($rzvy_translangArr['there_is_no_services_for_this_business'])) {
                                                echo $rzvy_translangArr['there_is_no_services_for_this_business'];
                                            } else {
                                                echo $rzvy_defaultlang['there_is_no_services_for_this_business'];
                                            }
                                            ?>
                                        </h5>
                                    </div>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <div class="service-meta">
                                    ...
                                    <span><i class="fa fa-fw fa-clock-o"></i>&nbsp;&nbsp;<strong><?php
                                            ...
                                            ?></strong>&nbsp;<?php echo $service['duration'] . " Minutes"; ?></span>
                                    <span><i class="fa fa-fw fa-map-marker"></i>&nbsp;&nbsp;<strong><?php
                                            if (isset($rzvy_translangArr['service_locations'])) {
                                                echo $rzvy_translangArr['service_locations'];
                                            } else {
            ...
            <div class="rzvy_show_hide_addons pt-5">
                <div class="step-item">
                    <h5 class="step-title <?php echo $inputAlignment; ?>"><?php
                        if (isset($rzvy_translangArr['select_additional_services'])) {
                            echo $rzvy_translangArr['select_additional_services'];
                        } else {
                            echo $rzvy_defaultlang['select_additional_services'];
                        }
                        ?></h5>
                </div>
            </div>
        ...
        /* Get available slots ajax */ else if (isset($_POST['get_slots_any_staff'])) {
            $rzvy_settings_timezone = $obj_settings->get_option("rzvy_timezone");
            $rzvy_server_timezone = date_default_timezone_get();
            $currDateTime_withTZ = $obj_settings->get_current_time_according_selected_timezone($rzvy_server_timezone, $rzvy_settings_timezone);
            ...
            if (isset($rzvy_translangArr['no_free_slots_today'])) {
                $noslot_message = $rzvy_translangArr['no_free_slots_today'];
            } else {
                $noslot_message = $rzvy_defaultlang['no_free_slots_today'];
            }

            if ($slotof == 'tomorrow') {
                $selected_date = date("Y-m-d", strtotime('+1 days', strtotime($selected_date)));
                if (isset($rzvy_translangArr['no_free_slots_tomorrow'])) {
                    $noslot_message = $rzvy_translangArr['no_free_slots_tomorrow'];
                } else {
                    $noslot_message = $rzvy_defaultlang['no_free_slots_tomorrow'];
                }
            }
        ...
        /** Set staff id in session on selection any slot */ else if (isset($_POST["set_staff_according_any"])) {
            $_SESSION['rzvy_staff_id'] = $_POST["id"];
        }